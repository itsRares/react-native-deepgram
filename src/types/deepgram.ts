...
export type DeepgramTextIntelligenceCallbackMethod =
  | 'POST'
  | 'PUT'
  | (string & {});

export type DeepgramTextIntelligenceCustomMode = 'extended' | 'strict';
...
export type DeepgramTextToSpeechCallbackMethod = 'POST' | 'PUT' | (string & {});
